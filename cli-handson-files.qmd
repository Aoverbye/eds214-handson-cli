...
```{bash, eval=FALSE, echo=TRUE}
# brun@taylor:~$ cd ~
# brun@taylor:~$ curl --output 10min-loop.R https://aurora.nceas.ucsb.edu/~brun/10min-loop.R
...
```{bash, eval=FALSE, echo=TRUE}
# brun@taylor:~$ cd ~/cli_intro
# brun@taylor:~/cli_intro$ curl --output sampledata.zip https://aurora.nceas.ucsb.edu/~brun/sampledata.zip 
